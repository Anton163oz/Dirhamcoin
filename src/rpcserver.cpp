...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Dirhamcoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Dirhamcoin server stopping";
}
...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* Dirhamcoin features */
    { "dirhamcoin",               "masternode",             &masternode,             true,      true,       false },
    { "dirhamcoin",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "dirhamcoin",               "masternodebroadcast",    &masternodebroadcast,    true,      true,       false },
    { "dirhamcoin",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "dirhamcoin",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "dirhamcoin",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "dirhamcoin",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "dirhamcoin",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "dirhamcoin",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use dirhamcoind, or the -server option to dirhamcoin-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> dirhamcoin-cli " + methodname + " " + args + "\n";
}
