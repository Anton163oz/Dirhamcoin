    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Dirhamcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Dirhamcoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  dirhamcoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Dirhamcoin Core is shutting down...") + "<br /><br />" +
