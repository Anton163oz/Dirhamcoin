    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Dirhamcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Dirhamcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dirhamcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Dirhamcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Dirhamcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Dirhamcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Dirhamcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Dirhamcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a dirhamcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Dirhamcoin Core help message to get a list with possible Dirhamcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Dirhamcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Dirhamcoin network", "", count));
}
...
{
    QString strTitle = tr("Dirhamcoin Core"); // default title
