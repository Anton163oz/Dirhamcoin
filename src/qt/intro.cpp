...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Dirhamcoin Core"),
     ...
     * override -datadir in the dirhamcoin.conf file in the default data directory
     * (to be consistent with dirhamcoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
