...
/* *** BEGIN DARKSEND MAGIC - DIRHAMCOIN **********
    Copyright (c) 2014-2015, Dirhamcoin Developers
        eduffield - evan@anton163oz.io
        udjinm6   - udjinm6@anton163oz.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Dirhamcoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("dirhamcoin-darksend");
