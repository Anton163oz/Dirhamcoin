...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Dirhamcoin Core dirhamcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dirhamcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dirhamcoin transaction") + "\n" +
              "  dirhamcoin-tx [options] -create [commands]   " + _("Create hex-encoded dirhamcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dirhamcoin transaction
